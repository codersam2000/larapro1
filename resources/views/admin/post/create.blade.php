      ...
      <div class="card my-3">
        ...
        <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="title" placeholder="Write title" id="name" value="{{ old('title') }}">
              <textarea id="editor" class="form-control mt-3" style="height:200px" name="des"></textarea>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="form-group">
              ...
              <select name="category_id" class="form-control mt-2">
                @if($categorier)
                @foreach($categorier as $category)
            ...
            <label for="img">
              Choose a photo <br>
            <img class="img-pv p-1" style="width:200px;height:auto; amrgin:auto;" src="{{ asset('assets/frontend/vendor/image/demo.png') }}"/>
            </label>
